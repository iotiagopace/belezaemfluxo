...
export default function FloatingWhatsApp({
  ...
  return (
    <a
      ...
      className="dark-on-light fixed bottom-24 right-5 z-40 hidden h-14 w-14 items-center justify-center rounded-full bg-[var(--color-whatsapp)] text-white shadow-lg transition hover:scale-105 md:inline-flex"
    >
