        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
          {SITE_CASES.map((c, i) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group block rounded-2xl overflow-hidden border border-white/10 bg-white/5 hover:border-white/30 transition-all"
            >
              ...
              <div className="p-6">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-white/50 inline-flex items-center gap-1 group-hover:text-white transition-colors text-xs lowercase">
                    abrir site
                    <ArrowRight size={12} />
                  </span>
                </div>
